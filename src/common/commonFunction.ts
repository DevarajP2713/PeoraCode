...
export const getMasterListsData = (
  listName: string,
...
// Tech changes start
export const getAllLibraryDatas = async () => {
  let Filtercondition = `
  ...
  let allPhotos = await getAllLibraryPhotos(
    LISTS.ORNAMENTS_PHOTOS.NAME,
    Filtercondition
  );
...
export const getAllPurchaseOrder = async () => {
  let queryParams = new GET_LIST_QUERY_PARAMS();
  queryParams.selectProperties = [
    "*,Attachments,AttachmentFiles,VendorName/Id,VendorName/VendorName",
  ];
...
export const getAllSalesOrder = async () => {
  let queryParams = new GET_LIST_QUERY_PARAMS();
  queryParams.selectProperties = [
    "*,Attachments,AttachmentFiles,Customer/Id,Customer/CustomerName,PricingScheme/Id,PricingScheme/Title",
  ];
...
export const getAllInventories = async () => {
  let queryParams = new GET_LIST_QUERY_PARAMS();
  queryParams.selectProperties = [
    "*,Attachments,AttachmentFiles,Category/Id,Category/CatName,Vendor/Id,Vendor/VendorName,MetalType/Id,MetalType/MetalTypeName,Length/Id,Length/Title,Width/Id,Width/Title,BoxType/Id,BoxType/Title,InsertType/Id,InsertType/Title,ChainType/Id,ChainType/Title,BackingType/Id,BackingType/Title,Subcategory/Id,Subcategory/SubCatName,Vendor2/Id,Vendor2/VendorName",
  ];
  queryParams.expandProperties = [
    "AttachmentFiles,Category,Vendor,MetalType,Length,Width,BoxType,InsertType,ChainType,BackingType,Subcategory,Vendor2",
  ];
    ...
    remainingLookUpData.forEach((ele) => {
      x[ele.name] =
        ele.data && ele.data.length > 0
          ? ele.data.filter((item) => item.Id === x[ele.name + "Id"])[0]
          : null;
    });
